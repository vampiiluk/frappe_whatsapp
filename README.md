...
> [!IMPORTANT]
> **What's New in This Fork** — this is the **vampiiluk/frappe_whatsapp** fork
> of Frappe WhatsApp. The upstream Meta Cloud API integration is fully intact;
> this fork **adds an Evolution API provider layer** so you can use any Evolution
> API instance instead of (or alongside) Meta.
>
